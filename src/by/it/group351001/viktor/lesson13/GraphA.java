...
/* реализуется топологическая сортировка ориентированного графа.
Топологическая сортировка — линейное упорядочение вершин графа, при котором для каждого ребра (u, v)
вершина u предшествует вершине v. */
public class GraphA {

    // метод выполняет рекурсивный обход графа в глубину для одной вершины.
    ...
    // метод выполняет топологическую сортировку всего графа - сортирует вершины графа в обратном порядке
