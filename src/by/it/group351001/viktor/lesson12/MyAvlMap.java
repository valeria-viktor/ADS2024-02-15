...
// Для каждого узла высота левого и правого поддеревьев может отличаться не более чем на 1. Это называется балансировочным фактором.
//ассоциативный массив, который использует AVL-дерево для хранения пар "ключ-значение"
public class MyAvlMap implements Map<Integer,String> {
    ...
    private class TreeNode {
        ...
        // Конструктор для создания пустого узл
        public TreeNode(){
            this.left = null;
            this.right = null;
            this.height = -1;
