...
import java.util.*;
//после каждой операции (поиска, вставки или удаления) дерево перестраивается таким образом,
// чтобы последний доступный узел стал корнем дерева.
// Это позволяет ускорить последующие операции с узлом, который был недавно использован.
public class MySplayMap implements NavigableMap<Integer, String> {

    // Внутренний класс для представления узла в дереве
    ...
    private TreeNode _root = null; // Корень дерева
